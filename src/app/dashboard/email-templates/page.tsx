...
const INDUSTRY_TEMPLATES: Record<string, Template[]> = {
  ...
  health_wellness: [
    { id: "t1", name: "Treatment Approved", category: "nurture", subject: "Great news — your treatment has been approved!", preview: "Hi {{firstName}}, your provider has reviewed your health profile and approved your treatment plan. Your prescription is now being prepared...", uses: 48, openRate: 92, clickRate: 45, starred: true },
    { id: "t2", name: "Prescription Sent to Pharmacy", category: "nurture", subject: "Your prescription has been sent to our pharmacy", preview: "Hi {{firstName}}, your prescription has been written and sent to our licensed compounding pharmacy. Preparation typically takes 2-3 business days...", uses: 42, openRate: 88, clickRate: 12, starred: true },
    { id: "t3", name: "Medication Shipped", category: "nurture", subject: "Your medication has shipped!", preview: "Hi {{firstName}}, your medication is on its way! Track your package: {{trackingUrl}}. Most shipments arrive within 3-5 business days...", uses: 38, openRate: 94, clickRate: 68, starred: true },
    { id: "t4", name: "Dosing Check-In (Week 4)", category: "follow_up", subject: "How are you feeling on your treatment?", preview: "Hi {{firstName}}, it's been 4 weeks since you started your {{treatment}} treatment. We'd love to hear how things are going...", uses: 24, openRate: 62, clickRate: 28, starred: false },
    { id: "t5", name: "Refill Reminder", category: "reminder", subject: "Time to refill your {{treatment}} prescription", preview: "Hi {{firstName}}, your current {{treatment}} supply is running low. Request a refill through your patient portal to avoid any gaps...", uses: 56, openRate: 72, clickRate: 52, starred: true },
    { id: "t6", name: "Abandoned Checkout Recovery", category: "win_back", subject: "You're one step away from starting your journey", preview: "Hi {{firstName}}, we noticed you started your consultation but didn't finish. Our providers are ready to review your health profile...", uses: 18, openRate: 48, clickRate: 32, starred: false },
    { id: "t7", name: "Provider Needs Info", category: "reminder", subject: "Your provider needs additional information", preview: "Hi {{firstName}}, your provider has reviewed your profile and needs a bit more information before finalizing your treatment plan...", uses: 8, openRate: 85, clickRate: 42, starred: false },
    { id: "t8", name: "Subscription Renewal Notice", category: "billing", subject: "Your {{treatment}} subscription renews on {{date}}", preview: "Hi {{firstName}}, your {{treatment}} subscription renews on {{date}} for {{amount}}. No action needed. Manage your plan anytime...", uses: 32, openRate: 58, clickRate: 15, starred: false },
  ],
  ecommerce: [
