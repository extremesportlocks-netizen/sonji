...
const DEMO_PROJECTS: Record<string, Project[]> = {
  ...
  health_wellness: [
    { id: "p1", name: "Weight Loss Program — 12 Week", client: "Sarah Thompson", status: "active", priority: "high", budgetAmount: 4800, budgetType: "fixed", hourlyRate: 0, retainerHours: 0, hoursLogged: 6, hoursEstimated: 12, costIncurred: 1200, revenue: 4800, margin: 75.0, startDate: "2026-02-20", dueDate: "2026-05-15", manager: "Dr. Patel", teamSize: 2, tasksTotal: 12, tasksDone: 4, tags: ["Weight Loss", "Active"] },
    { id: "p2", name: "Botox + Filler Series", client: "Maria Santos", status: "active", priority: "medium", budgetAmount: 2400, budgetType: "fixed", hourlyRate: 0, retainerHours: 0, hoursLogged: 2, hoursEstimated: 4, costIncurred: 600, revenue: 2400, margin: 75.0, startDate: "2026-03-01", dueDate: "2026-06-01", manager: "Dr. Kim", teamSize: 1, tasksTotal: 4, tasksDone: 1, tags: ["Botox", "Series"] },
    { id: "p3", name: "Wellness Annual Plan", client: "Patricia Lee", status: "planning", priority: "high", budgetAmount: 3600, budgetType: "retainer", hourlyRate: 0, retainerHours: 0, hoursLogged: 0, hoursEstimated: 12, costIncurred: 0, revenue: 3600, margin: 100, startDate: "2026-04-01", dueDate: "2026-03-31", manager: "Dr. Patel", teamSize: 2, tasksTotal: 12, tasksDone: 0, tags: ["Wellness", "Annual"] },
    { id: "p4", name: "IV Therapy Package", client: "David Kim", status: "completed", priority: "low", budgetAmount: 1200, budgetType: "fixed", hourlyRate: 0, retainerHours: 0, hoursLogged: 3, hoursEstimated: 3, costIncurred: 450, revenue: 1200, margin: 62.5, startDate: "2026-02-01", dueDate: "2026-03-01", manager: "Dr. Kim", teamSize: 1, tasksTotal: 4, tasksDone: 4, tags: ["IV Therapy", "Completed"] },
  ],
  home_services: [
