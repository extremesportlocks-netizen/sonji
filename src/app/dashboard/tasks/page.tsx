...
const INDUSTRY_TASKS: Record<string, Task[]> = {
  ...
  health_wellness: [
    { id: "dt1", title: "Review new patient intake — Sarah Mitchell", description: "Tirzepatide Monthly, BMI 32, no contraindications", priority: "high", status: "todo", assignedTo: "Provider", contactName: "Sarah Mitchell", dueDate: "2026-03-18", createdAt: "2026-03-18" },
    { id: "dt2", title: "Follow up — Jessica Brown dosage check-in", description: "Week 4 on Tirzepatide, check progress and side effects", priority: "high", status: "todo", assignedTo: "Provider", contactName: "Jessica Brown", dueDate: "2026-03-19", createdAt: "2026-03-17" },
    { id: "dt3", title: "Process refill request — Jennifer Adams", description: "Semaglutide 3-Month refill #2, screening answers submitted", priority: "medium", status: "todo", assignedTo: "Provider", contactName: "Jennifer Adams", dueDate: "2026-03-18", createdAt: "2026-03-17" },
    { id: "dt4", title: "Respond to patient message — Michael Torres", description: "Question about injection site rotation", priority: "medium", status: "in_progress", assignedTo: "Provider", contactName: "Michael Torres", dueDate: "2026-03-18", createdAt: "2026-03-17" },
    { id: "dt5", title: "Verify pharmacy shipment — David Park", description: "Tirzepatide 3-Month shipped 3 days ago, confirm delivery", priority: "low", status: "in_progress", assignedTo: "Operations", contactName: "David Park", dueDate: "2026-03-19", createdAt: "2026-03-16" },
    { id: "dt6", title: "Abandoned cart follow-up — Carlos Rivera", description: "Started Tirz Monthly checkout, didn't complete", priority: "medium", status: "done", assignedTo: "Operations", contactName: "Carlos Rivera", dueDate: "2026-03-17", createdAt: "2026-03-16" },
    { id: "dt7", title: "Update treatment FAQ — new dosing guidelines", description: "FDA updated compounding guidance, review FAQ answers", priority: "low", status: "done", assignedTo: "Operations", contactName: "Internal", dueDate: "2026-03-15", createdAt: "2026-03-12" },
  ],
  ecommerce: [
