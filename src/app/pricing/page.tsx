...
const featureGroups = [
  ...
  {
    name: "Advanced",
    features: ["Basic Analytics", "Advanced Analytics", "Custom Domain", "AI Assistant", "Automation Builder", "Project Management", "Ghosting Alerts"],
  },
  {
    name: "Scale Features",
